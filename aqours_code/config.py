...
VERIFIER_MAX_MODEL_CALLS = _env_int(
    "AQOURS_CODE_VERIFIER_MAX_MODEL_CALLS", 8,
)
VERIFIER_RESOLUTION_RESERVE = _env_int(
    "AQOURS_CODE_VERIFIER_RESOLUTION_RESERVE", 2,
)
VERIFIER_SAFETY_MARGIN = _env_int(
    "AQOURS_CODE_VERIFIER_SAFETY_MARGIN", 1,
)
VERIFIER_MAX_TOOL_CALLS = _env_int(
    "AQOURS_CODE_VERIFIER_MAX_TOOL_CALLS", 12,
)
