...
def validate_runtime_configuration() -> None:
    ...
    if EMERGENCY_MAX_PROVIDER_REQUESTS <= 0:
        raise RuntimeError(
            "AQOURS_CODE_EMERGENCY_MAX_PROVIDER_REQUESTS must be greater than zero"
        )
...
EMERGENCY_MAX_PROVIDER_REQUESTS = _env_int(
    "AQOURS_CODE_EMERGENCY_MAX_PROVIDER_REQUESTS", 100,
)
