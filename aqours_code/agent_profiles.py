...
AGENT_PROFILES = {
    ...
    "review": AgentProfile(
        ...
        instructions=(
            ...
            "contract section relevant to the root task, not only failing "
            ...
            "When a contract promises fresh copies, trace nested mutable values "
            "through repositories, caches, serializers, returns, and replays; do "
            "not infer copy isolation from the service layer alone. "
            ...
            "keys verdict, summary, findings, files_checked, and missing_evidence. "
